...
export function FieldName({ name, onAdd }: FieldNameProps) {
  return (
    <div className="bg-secondary text-txt-muted border-bg-mod-border sticky top-0 z-10 flex flex-row items-center border-y py-1 pl-4 pr-2 text-base font-semibold">
